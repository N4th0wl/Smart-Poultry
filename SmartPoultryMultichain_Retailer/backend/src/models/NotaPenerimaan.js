...
const NotaPenerimaan = sequelize.define('NotaPenerimaan', {
    ...
    KodeNotaPengirimanProcessor: { type: DataTypes.STRING(25), allowNull: true },
    ...
    KondisiBarang: { type: DataTypes.ENUM('BAIK', 'CUKUP', 'BURUK'), allowNull: false, defaultValue: 'BAIK' },
