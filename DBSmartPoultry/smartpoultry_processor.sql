...
CREATE DATABASE smartpoultry_processor;
...
CREATE TABLE `orders` (
  ...
  `IdProcessor` int DEFAULT NULL,
  `KodePeternakan` varchar(50) DEFAULT NULL,
...
INSERT INTO `orders` (`IdOrder`, `KodeOrder`, `IdProcessor`, `KodePeternakan`, `NamaPeternakan`, `AlamatPeternakan`, `KontakPeternakan`, `JenisAyam`, `JumlahPesanan`, `Satuan`, `TanggalOrder`, `TanggalDibutuhkan`, `HargaSatuan`, `TotalHarga`, `StatusOrder`, `PenerimaOrder`, `JumlahDiterima`, `KondisiTerima`, `TanggalDiterima`, `Catatan`, `DibuatOleh`, `CreatedAt`, `UpdatedAt`) VALUES
(2, 'ORD-000000002', NULL, '1', 'Peternakan Rudy', 'Gading Serpong', NULL, 'Ayam Utuh', 97, 'EKOR', '2026-03-31', '2026-04-01', 0.00, 0.00, 'CONFIRMED', NULL, NULL, NULL, NULL, 'Order dari Retailer: ORD-000000001 — Toko Ayam Pak Rudy', 5, '2026-03-31 12:43:05', '2026-03-31 12:43:50');
...
INSERT INTO `users` (`IdUser`, `KodeUser`, `IdProcessor`, `Email`, `Password`, `Role`, `StatusAkun`, `CreatedAt`, `UpdatedAt`) VALUES
(5, 'USR-000000001', NULL, 'processorrudy@gmail.com', '$2b$10$i2gyKK8Ml0/6w6O.iHhLYOrFtceao70BoHR.7.Iq7wuVDHYLRkJKa', 'ADMIN', 'ACTIVE', '2026-03-31 12:14:03', '2026-03-31 12:14:03');
...
--
ALTER TABLE `ledger_processor`
  ADD CONSTRAINT `ledger_processor_ibfk_1` FOREIGN KEY (`IdIdentity`) REFERENCES `blockchainidentity` (`IdIdentity`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ledger_processor_ibfk_2` FOREIGN KEY (`IdProcessor`) REFERENCES `processor` (`IdProcessor`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `ledger_processor_ibfk_3` FOREIGN KEY (`IdOrder`) REFERENCES `orders` (`IdOrder`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `ledger_processor_ibfk_4` FOREIGN KEY (`IdProduksi`) REFERENCES `produksi` (`IdProduksi`) ON DELETE SET NULL ON UPDATE CASCADE;
